...
(function () {
    ...
    var headerHTML = [
        ...
        'Xem tiếp',
        '</a>',
        '<a href="watch-time-notes.html" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">',
        '<i class="fas fa-sticky-note w-5 mr-3 text-yellow-400"></i>',
        'Ghi chú thời gian',
        '</a>',
